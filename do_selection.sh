...
### LONG SAMPLE LIST
i=$((${i} + 1))
infile[${i}]="radion_tree_v08b/RadionToHH_2Gamma_2b.root"
tree[${i}]="Radion_m270_8TeV"
outtree[${i}]="Radion_m270_8TeV"
typ[${i}]="-270"

i=$((${i} + 1))
infile[${i}]="radion_tree_v08b/Radion_nm.root"
...
### MSSM samples
i=$((${i} + 1))
infile[${i}]="radion_tree_v08b/MSSM_Higgs_RD.root"
...
###### GRAVITON
i=$((${i} + 1))
infile[${i}]="radion_tree_v08b/Graviton.root"
...
###### SM Higgs
i=$((${i} + 1))
infile[${i}]="radion_tree_v08b/SMHiggs.root"

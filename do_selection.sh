...
then
    i=$((${i} + 1))
    infile[${i}]="radion_redu_12_tree_10/tree_Data.root"
    tree[${i}]="Data"
    outtree[${i}]="Data"B
    typ[${i}]="0"
    CS[${i}]="0"
...
then
    i=$((${i} + 1))
    infile[${i}]="radion_tree_12_tree_10/tree_Signal.root"
...
then
    i=$((${i} + 1))
    infile[${i}]="radion_redu_12_tree_10/tree_Signal.root"
...
then
    i=$((${i} + 1))
    infile[${i}]="radion_redu_12_tree_10/tree_Bkg_v2.root"

...
##### SIGNAL
i=$((${i} + 1))
infile[${i}]="radion_tree_v07b/RadionToHH_2Gamma_2b.root"
...
i=$((${i} + 1))
infile[${i}]="radion_tree_v07b/MSSM_Higgs_m260.root"
tree[${i}]="MSSM_H_m260_8TeV"
outtree[${i}]="Radion_m260_8TeV"
typ[${i}]="-260"

i=$((${i} + 1))
infile[${i}]="radion_tree_v07b/MSSM_Higgs_m350.root"
...
#outtree[${i}]="Radion_m300_8TeV_nm"
#typ[${i}]="-300"

#i=$((${i} + 1))
#infile[${i}]="radion_tree_v07/Radioon-Graviton_nm.root"
#tree[${i}]="Radion_m500_8TeV_nm"
#outtree[${i}]="Radion_m500_8TeV_nm"
#typ[${i}]="-500"

#i=$((${i} + 1))
#infile[${i}]="radion_tree_v07/Radioon-Graviton_nm.root"
#tree[${i}]="Radion_m700_8TeV_nm"
#outtree[${i}]="Radion_m700_8TeV_nm"
#typ[${i}]="-700"
...
do
	...
	do
		echo -e "isample= ${isample}\tinfile= ${infile[${isample}]}\ttree= ${tree[${isample}]}\touttree= ${outtree[${isample}]}\ttyp= ${typ[${isample}]}\tireg= ${ireg}"

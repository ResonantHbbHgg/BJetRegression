...
#        c1.cd(2)
        ...
        gr_low[igraph].GetYaxis().SetTitleSize(35)
        gr_low[igraph].GetYaxis().SetLabelSize(25)
...
#    legend.SetTextSize(18) # in pixel
    ...
    legend.AddEntry(gr_low[2].GetName(), "#gamma preselection + p_{T} cutoffs", "lp")
    legend.AddEntry(gr_low[3].GetName(), "#gamma identification", "lp")
    legend.AddEntry(gr_low[4].GetName(), "jet identification", "lp")
    legend.AddEntry(gr_low[5].GetName(), "at least one b-tagged jet", "lp")
    legend.AddEntry(gr_low[6].GetName(), "mass cutoffs", "lp")
    legend.Draw()
    latexLabel = TLatex()

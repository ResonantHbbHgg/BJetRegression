...
gr2.Draw("LP");
gr3.Draw("LP");
legend.AddEntry(gr0.GetName(), "High+Medium Purity - ggHH", "lp")
legend.AddEntry(gr1.GetName(), "High+Medium Purity - #lambda-reweighted", "lp")
legend.AddEntry(gr2.GetName(), "High Purity - ggHH", "lp")
legend.AddEntry(gr3.GetName(), "High Purity - #lambda-reweighted", "lp")
legend.Draw()
latexLabel = TLatex()

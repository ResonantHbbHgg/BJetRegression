...
c1 = TCanvas()
afs_plottree = "/afs/cern.ch/work/o/obondu/Higgs/CMSSW_6_1_1_radion_v2/src/BJetRegression/2014-10-21_selection_noRegression_noMassCut_v17/"
...
samples.append(["Radion_m300", -300, afs_plottree, "", "Radion_m300_8TeV_noRegression_noMassCut_v*.root", "Radion_m300_8TeV", "evweight_w_btagSF", ROOT.kBlue-2, 0, "m_{X} = 300 GeV" , 13.55e-3, 39971])
samples.append(["Radion_m500", -50, afs_plottree, "", "Radion_m500_8TeV_noRegression_noMassCut_v*.root", "Radion_m500_8TeV", "evweight_w_btagSF", ROOT.kMagenta+2, 0, "m_{X} = 500 GeV" , 13.55e-3, 39969])
#samples.append(["Data", 0, afs_plottree, "", "Data_noRegression_noMassCut_v*.root", "Data", "(gg_mass < 120 || gg_mass > 130) * (njets_kRadionID_and_CSVM >= 0)", ROOT.kBlack, 0, "Data (m_{#gamma#gamma}-blind)", 1., 1001822])
#samples.append(["Data", 0, afs_plottree, "", "Data_noRegression_noMassCut_v*.root", "Data", "njets_kRadionID_and_CSVM >= 0", ROOT.kBlack, 0, "Data (unblind)", 1., 1001822])
...
samples.append(["ggHH_8TeV", -70, afs_plottree, "", "ggHH_8TeV_noRegression_noMassCut_v*.root", "ggHH_8TeV", "evweight_w_btagSF / 0.0000212", ROOT.kGreen+2, 0, "SM HH" , 13.55e-3, 96880])
#samples.append(["ggHH_8TeV", 70, afs_plottree, "", "ggHH_8TeV_noRegression_noMassCut_v*.root", "ggHH_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kRed+2, 1001, "SM Higgs" , 1., 14404429])
#samples.append(["bbh_m125_8TeV", 70, afs_plottree, "", "bbh_m125_8TeV_noRegression_noMassCut_v*.root", "bbh_m125_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kRed+2, 1001, "SM Higgs" , 1., 99434])
#samples.append(["tth_m125_8TeV", 70, afs_plottree, "", "tth_m125_8TeV_noRegression_noMassCut_v*.root", "tth_m125_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kRed+2, 1001, "SM Higgs" , 1., 93183])
#samples.append(["wzh_m125_8TeV_zh", 70, afs_plottree, "", "wzh_m125_8TeV_zh_noRegression_noMassCut_v*.root", "wzh_m125_8TeV_zh", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kRed+2, 1001, "SM Higgs" , 1., 100151])
#samples.append(["wzh_m125_8TeV_wh", 70, afs_plottree, "", "wzh_m125_8TeV_wh_noRegression_noMassCut_v*.root", "wzh_m125_8TeV_wh", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kRed+2, 1001, "SM Higgs" , 1., 100151])
#samples.append(["vbf_m125_8TeV", 70, afs_plottree, "", "vbf_m125_8TeV_noRegression_noMassCut_v*.root", "vbf_m125_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kRed+2, 1001, "SM Higgs" , 1., 99671])
#samples.append(["ggh_m125_powheg_8TeV", 70, afs_plottree, "", "ggh_m125_powheg_8TeV_noRegression_noMassCut_v*.root", "ggh_m125_powheg_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kRed+2, 1001, "SM Higgs" , 1., 99870])
#samples.append(["ZGToLLG_8TeV", 60, afs_plottree, "", "ZGToLLG_8TeV_noRegression_noMassCut_v*.root", "ZGToLLG_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kCyan+2, 1001, "W/Z + #gamma/#gamma#gamma" , 1., 14404429])
#samples.append(["LNuGG_ISR_8TeV", 60, afs_plottree, "", "LNuGG_ISR_8TeV_noRegression_noMassCut_v*.root", "LNuGG_ISR_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kCyan+2, 1001, "W/Z + #gamma/#gamma#gamma" , 1., 14404429])
#samples.append(["LNuGG_FSR_8TeV", 60, afs_plottree, "", "LNuGG_FSR_8TeV_noRegression_noMassCut_v*.root", "LNuGG_FSR_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kCyan+2, 1001, "W/Z + #gamma/#gamma#gamma" , 1., 14404429])
#samples.append(["TTGJets_8TeV", 50, afs_plottree, "", "TTGJets_8TeV_noRegression_noMassCut_v*.root", "TTGJets_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kYellow+2, 1001, "t/t#bar{t} + #gamma/#gamma#gamma" , 1., 14404429])
#samples.append(["tGG_8TeV", 50, afs_plottree, "", "tGG_8TeV_noRegression_noMassCut_v*.root", "tGG_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kYellow+2, 1001, "t/t#bar{t} + #gamma/#gamma#gamma" , 1., 14404429])
#samples.append(["ttGG_8TeV", 50, afs_plottree, "", "ttGG_8TeV_noRegression_noMassCut_v*.root", "ttGG_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kYellow+2, 1001, "t/t#bar{t} + #gamma/#gamma#gamma" , 1., 14404429])
#samples.append(["DYJetsToLL", 40, afs_plottree, "", "DYJetsToLL_noRegression_noMassCut_v*.root", "DYJetsToLL", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kMagenta+2, 1001, "DY" , 1., 14404429])
#samples.append(["qcd_40_8TeV_ff", 30, afs_plottree, "", "qcd_40_8TeV_ff_noRegression_noMassCut_v*.root", "qcd_40_8TeV_ff", "(evweight_w_btagSF) * (njets_kRadionID_and_CSVM >= 0)", ROOT.kBlue+3, 1001, "QCD j" , 1., 14404429])
#samples.append(["qcd_30_8TeV_ff", 30, afs_plottree, "", "qcd_30_8TeV_ff_noRegression_noMassCut_v*.root", "qcd_30_8TeV_ff", "(evweight_w_btagSF) * (njets_kRadionID_and_CSVM >= 0)", ROOT.kBlue+3, 1001, "QCD j" , 1., 14404429])
#samples.append(["qcd_30_8TeV_pf", 20, afs_plottree, "", "qcd_30_8TeV_pf_noRegression_noMassCut_v*.root", "qcd_30_8TeV_pf", "(evweight_w_btagSF) * (njets_kRadionID_and_CSVM >= 0)", ROOT.kBlue-4, 1001, "QCD #gamma + j" , 1., 6047441])
#samples.append(["qcd_40_8TeV_pf", 20, afs_plottree, "", "qcd_40_8TeV_pf_noRegression_noMassCut_v*.root", "qcd_40_8TeV_pf", "(evweight_w_btagSF) * (njets_kRadionID_and_CSVM >= 0)", ROOT.kBlue-4, 1001, "QCD #gamma + j" , 1., 9764546])
#samples.append(["gjet_20_8TeV_pf", 20, afs_plottree, "", "gjet_20_8TeV_pf_noRegression_noMassCut_v*.root", "gjet_20_8TeV_pf", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kBlue-4, 1001, "QCD #gamma + j" , 1., 5901106])
#samples.append(["gjet_40_8TeV_pf", 20, afs_plottree, "", "gjet_40_8TeV_pf_noRegression_noMassCut_v*.root", "gjet_40_8TeV_pf", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kBlue-4, 1001, "QCD #gamma + j" , 1., 17722752])
#samples.append(["diphojet_sherpa_8TeV", 10, afs_plottree, "", "diphojet_sherpa_8TeV_noRegression_noMassCut_v*.root", "diphojet_sherpa_8TeV", "evweight_w_btagSF * (njets_kRadionID_and_CSVM >= 0)", ROOT.kGreen+2, 1001, "QCD #gamma#gamma + j" , 1., 14404429])
#samples.append(["ggHH_Lam_0d0_Yt_1d0_c2_0d0_8TeV", -500010000, afs_plottree, "", "ggHH_Lam_0d0_Yt_1d0_c2_0d0_8TeV_noRegression_noMassCut_v*.root", "ggHH_Lam_0d0_Yt_1d0_c2_0d0_8TeV", "evweight_w_btagSF", ROOT.kRed, 0, "(#lambda, y_{t}, c_{2}) = (0, 1, 0)" , 13.55e-3, 19600])

#samples.append(["ggHH_Lam_1d0_Yt_1d0_c2_0d0_8TeV", -501010000, afs_plottree, "", "ggHH_Lam_1d0_Yt_1d0_c2_0d0_8TeV_noRegression_noMassCut_v*.root", "ggHH_Lam_1d0_Yt_1d0_c2_0d0_8TeV", "evweight_w_btagSF", ROOT.kBlue, 0, "(#lambda, y_{t}, c_{2}) = (1, 1, 0)" , 13.55e-3, 20000])
#samples.append(["ggHH_Lam_1d0_Yt_1d0_c2_0d0_8TeV", -501010000, "", "", "ggHH_Lam_1d0_Yt_1d0_c2_0d0_8TeV_noRegression_noMassCut_v*.root", "ggHH_Lam_1d0_Yt_1d0_c2_0d0_8TeV", "evweight_w_btagSF", ROOT.kBlue, 0, "(#lambda, y_{t}, c_{2}) = (1, 1, 0)" , 13.55e-3, 20000])
#samples.append(["ggHH_8TeV", 500000000, afs_plottree, "", "ggHH_8TeV_noRegression_noMassCut_v*.root", "ggHH_8TeV", "evweight_w_btagSF", ROOT.kRed, 0, "SM" , 13.55e-3, 96880])

...
samples.append(["Radion_m300", "/afs/cern.ch/work/f/fbojarsk/CMSSW_6_1_1/src/BJetRegression/", "2014-05-12_selection_noRegression_noMassCut_v10bis_effStudies", "Radion_m300_8TeV_noRegression_noMassCut_v10bis_effStudies.root", "Radion_m300_8TeV", ROOT.kBlack, 0, "m_{X} = 300 GeV", 13.55e-3, 19999])
samples.append(["Radion_m300", "/afs/cern.ch/work/f/fbojarsk/CMSSW_6_1_1/src/BJetRegression/", "2014-05-12_selection_noRegression_noMassCut_v10bis_effStudies_no_dR2Mean", "Radion_m300_8TeV_noRegression_noMassCut_v10bis_effStudies.root", "Radion_m300_8TeV", ROOT.kRed, 0, "m_{X} = 300 GeV no cut dr2mean", 13.55e-3, 19999])
samples.append(["Radion_m300", "/afs/cern.ch/work/f/fbojarsk/CMSSW_6_1_1/src/BJetRegression/", "2014-05-12_selection_noRegression_noMassCut_v10bis_effStudies_no_cut_betastar", "Radion_m300_8TeV_noRegression_noMassCut_v10bis_effStudies.root", "Radion_m300_8TeV", ROOT.kBlue, 0, "m_{X} = 300 GeV no cut betastar", 13.55e-3, 19999])
samples.append(["Radion_m300", "/afs/cern.ch/work/f/fbojarsk/CMSSW_6_1_1/src/BJetRegression/", "2014-05-12_selection_noRegression_noMassCut_v10bis_effStudies_no_cut_betastar_&_dr2mean", "Radion_m300_8TeV_noRegression_noMassCut_v10bis_effStudies.root", "Radion_m300_8TeV", ROOT.kGreen, 0, "m_{X} = 300 GeV no cut betastar  & dr2mean", 13.55e-3, 19999])
...
plots.append(["gr_b_DeltaR_min_jet1_cat1", "gr_b_DeltaR_min_jet1", "njets_kRadionID_and_CSVM == 1", 2., "(50, 0, 5)", "gr_b_DeltaR_min_jet1_cat1", "", "", ""])
plots.append(["gr_b_DeltaR_min_jet1_cat0", "gr_b_DeltaR_min_jet1", "njets_kRadionID_and_CSVM >= 2", 2., "(50, 0, 5)", "gr_b_DeltaR_min_jet1_cat0", "", "", ""])
plots.append(["gr_b_DeltaR_min_jet2_cat1", "gr_b_DeltaR_min_jet2", "njets_kRadionID_and_CSVM == 1", 2., "(50, 0, 5)", "gr_b_DeltaR_min_jet2_cat1", "", "", ""])
plots.append(["gr_b_DeltaR_min_jet2_cat0", "gr_b_DeltaR_min_jet2", "njets_kRadionID_and_CSVM >= 2", 2., "(50, 0, 5)", "gr_b_DeltaR_min_jet2_cat0", "", "", ""])
plots.append(["tagada", "gr_b_DeltaR_min_jet2", "gr_b_DeltaR_min_jet2 >= .2", 2., "(50, 0, 5)", "tagada", "", "", ""])
...
#        print ifile, file, color, style, label
        ...
        nselected = chain.GetEntries("somevar > somecut")

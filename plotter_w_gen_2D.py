...
samples.append(["ggHH1_8TeV", "", "../LHEAnalysis", "original_gen_1.root", "test", "1", ROOT.kBlue, 0, "#lambda = 0", 0.0000212, 100000])
samples.append(["ggHH0_8TeV", "", "../LHEAnalysis", "weighted_gen_2D_0.root", "test", "weight_lambda", ROOT.kRed, 0, "#lambda = 1 x w_#lambda=0", 0.0000212, 100000])
samples.append(["ggHH2_8TeV", "", "../LHEAnalysis", "weighted_gen_2D_2.root", "test", "weight_lambda", ROOT.kGreen, 0, "#lambda = 1 x w_#lambda=2", 0.0000212, 100000])
...
plots.append(["2D_gr_w_g1_p4_pt", "gr_g1_p4_pt", "", 1., "(50, 0, 500)", "p_{T}^{#gamma1} (GeV)", "", "", ""])
plots.append(["2D_gr_w_g1_p4_eta", "gr_g1_p4_eta", "", 1., "(50, -4, 4)", "eta^{#gamma1} ", "", "", ""])
plots.append(["2D_gr_w_g1_p4_phi", "gr_g1_p4_phi", "", 1., "(50, -4, 4)", "phi^{#gamma1} (radian)", "", "", ""])
plots.append(["2D_gr_w_g1_p4_mass", "gr_g1_p4_mass", "", 1., "(100, 0, 200)", "mass^{#gamma1} (GeV", "", "", ""])
plots.append(["2D_gr_w_g2_p4_pt", "gr_g2_p4_pt", "", 1., "(50, 0, 500)", "p_{T}^{#gamma2} (GeV)", "", "", ""])
plots.append(["2D_gr_w_g2_p4_eta", "gr_g2_p4_eta", "", 1., "(50, -4, 4)", "eta^{#gamma2} ", "", "", ""])
plots.append(["2D_gr_w_g2_p4_phi", "gr_g2_p4_phi", "", 1., "(50, -4, 4)", "phi^{#gamma2} (radian)", "", "", ""])
plots.append(["2D_gr_w_g2_p4_mass", "gr_g2_p4_mass", "", 1., "(100, 0, 200)", "mass^{#gamma2} (GeV)", "", "", ""])

# b quark and anti b quark (lhe2root.py)
plots.append(["2D_gr_w_b1_p4_pt", "gr_b1_p4_pt", "", 1., "(50, 0, 500)", "p_{T}^{#b1} (GeV)", "", "", ""])
plots.append(["2D_gr_w_b1_p4_eta", "gr_b1_p4_eta", "", 1., "(50, -4, 4)", "eta^{#b1} ", "", "", ""])
plots.append(["2D_gr_w_b1_p4_phi", "gr_b1_p4_phi", "", 1., "(50, -4, 4)", "phi^{#b1} (radian)", "", "", ""])
plots.append(["2D_gr_w_b1_p4_mass", "gr_b1_p4_mass", "", 1., "(100, 0, 200)", "mass^{#b1} (GeV", "", "", ""])
plots.append(["2D_gr_w_b2_p4_pt", "gr_b2_p4_pt", "", 1., "(50, 0, 500)", "p_{T}^{#b2} (GeV)", "", "", ""])
plots.append(["2D_gr_w_b2_p4_eta", "gr_b2_p4_eta", "", 1., "(50, -4, 4)", "eta^{#b2} ", "", "", ""])
plots.append(["2D_gr_w_b2_p4_phi", "gr_b2_p4_phi", "", 1., "(50, -4, 4)", "phi^{#b2} (radian)", "", "", ""])
plots.append(["2D_gr_w_b2_p4_mass", "gr_b2_p4_mass", "", 1., "(100, 0, 200)", "mass^{#b2} (GeV)", "", "", ""])

# hgg and hbb (lhe2root.py)
plots.append(["2D_gr_w_hgg_p4_pt", "gr_hgg_p4_pt", "", 1., "(50, 0, 500)", "p_{T}^{#hgg} (GeV)", "", "", ""])
plots.append(["2D_gr_w_hgg_p4_eta", "gr_hgg_p4_eta", "", 1., "(50, -4, 4)", "eta^{#hgg} ", "", "", ""])
plots.append(["2D_gr_w_hgg_p4_phi", "gr_hgg_p4_phi", "", 1., "(50, -4, 4)", "phi^{#hgg} (radian)", "", "", ""])
plots.append(["2D_gr_w_hgg_p4_mass", "gr_hgg_p4_mass", "", 1., "(100, 0, 200)", "mass^{#hgg} (GeV", "", "", ""])
plots.append(["2D_gr_w_hbb_p4_pt", "gr_hbb_p4_pt", "", 1., "(50, 0, 500)", "p_{T}^{#hbb} (GeV)", "", "", ""])
#plots.append(["gr_w_hbb_p4_pt_costhetastar_0_0.3", "gr_hbb_p4_pt", "costhetastar_CS < 0.3", 1., "(50, 0, 500)", "p_{T}^{#hbb} (GeV)", "|cos#theta*|^{#hh} < 0.3", "", ""])
#plots.append(["gr_w_hbb_p4_pt_costhetastar_0.3_0.6", "gr_hbb_p4_pt", "costhetastar_CS > 0.3 && costhetastar_CS < 0.6", 1., "(50, 0, 500)", "p_{T}^{#hbb} (GeV)", "0.3 < |cos#theta*|^{#hh} < 0.6", "", ""])
#plots.append(["gr_w_hbb_p4_pt_costhetastar_0.6_0.9", "gr_hbb_p4_pt", "costhetastar_CS > 0.6 && costhetastar_CS < 0.9", 1., "(50, 0, 500)", "p_{T}^{#hbb} (GeV)", "0.6 < |cos#theta*|^{#hh} < 0.9", "", ""])
#plots.append(["gr_w_hbb_p4_pt_costhetastar_0.9_1", "gr_hbb_p4_pt", "costhetastar_CS > 0.9 && costhetastar_CS < 1", 1., "(50, 0, 500)", "p_{T}^{#hbb} (GeV)", "0.9 < |cos#theta*|^{#hh} < 1", "", ""])
...
#plots.append(["gr_w_costhetastar_pt_150_200", "costhetastar_CS", "gr_hbb_p4_pt > 150 && gr_hbb_p4_pt < 200", 1., "(50, 0, 1)", "|cos#theta*|^{#hh}", "150 < p_{T}^{h} < 200 GeV", "", ""])
#plots.append(["gr_w_costhetastar_pt_200_500", "costhetastar_CS", "gr_hbb_p4_pt > 200 && gr_hbb_p4_pt < 1000", 1., "(50, 0, 1)", "|cos#theta*|^{#hh}", "200 < p_{T}^{h} < 500 GeV", "", ""])
#plots.append(["2D_gr_w_delta_eta", "dEta_gg_jj", "", 1., "(50, -6, 6)", "#Delta#eta^{#hh}", "", "", ""])
#plots.append(["2D_gr_w_delta_phi", "dPhi_gg_jj", "", 1., "(50, -6, 6)", "#Delta#phi^{#hh}", "", "", ""])
...
#        print ifile, file, color, style, label
    ...
    latexLabel.DrawLatex(.28, .79, "Englert plots weighted by 2D weight (w_lambda)" )
    ...
    if cutline2 != "":
        ...
        line2.Draw("same")
    c1.Update()
    c1.Print("weighted_gen-level_plots_pdf/" + name2 + ".pdf")
    c1.Print("weighted_gen-level_plots_gif/" + name2 + ".gif")
    c1.Print("weighted_gen-level_plots_root/" + name2 + ".root")
    ...
    if cutline2 != "":
        ...
        line2.Draw("same")
    c1.Update()
    c1.Print("weighted_gen-level_plots_pdf/" + name2 + "_log.pdf")
    c1.Print("weighted_gen-level_plots_gif/" + name2 + "_log.gif")
    c1.Print("weighted_gen-level_plots_root/" + name2 + "_log.root")
    c1.SetLogy(0)

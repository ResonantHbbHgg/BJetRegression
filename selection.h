...
void setup_intree(TTree* intree, tree_variables *t, int type, int numberOfRegressionFiles)
{
    ...
    if( type != 0 ) intree->SetBranchAddress("j1_btagEff_M", &t->j1_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j1_btagEffError_M", &t->j1_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j2_btagEff_M", &t->j2_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j2_btagEffError_M", &t->j2_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j3_btagEff_M", &t->j3_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j3_btagEffError_M", &t->j3_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j4_btagEff_M", &t->j4_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j4_btagEffError_M", &t->j4_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j5_btagEff_M", &t->j5_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j5_btagEffError_M", &t->j5_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j6_btagEff_M", &t->j6_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j6_btagEffError_M", &t->j6_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j7_btagEff_M", &t->j7_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j7_btagEffError_M", &t->j7_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j8_btagEff_M", &t->j8_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j8_btagEffError_M", &t->j8_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j9_btagEff_M", &t->j9_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j9_btagEffError_M", &t->j9_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j10_btagEff_M", &t->j10_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j10_btagEffError_M", &t->j10_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j11_btagEff_M", &t->j11_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j11_btagEffError_M", &t->j11_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j12_btagEff_M", &t->j12_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j12_btagEffError_M", &t->j12_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j13_btagEff_M", &t->j13_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j13_btagEffError_M", &t->j13_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j14_btagEff_M", &t->j14_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j14_btagEffError_M", &t->j14_btagEffError_M);
    ...
    if( type != 0 ) intree->SetBranchAddress("j15_btagEff_M", &t->j15_btagEff_M);
    if( type != 0 ) intree->SetBranchAddress("j15_btagEffError_M", &t->j15_btagEffError_M);
...
//        else if( !isEB && (fabs(sceta) > 2.) && (r9 > .94) ) return 0.12 * 0.01;
    ...
    // USED FOR HIG-13-032 PAPER (PAPER HIG-13-001 got approved in the meantime)
